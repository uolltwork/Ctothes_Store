 ...
 * @author PC
 */
@WebServlet(name = "ManageOrders", urlPatterns = {"/manageOrder"})
public class ManageOrders extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Orders> listOrders = odao.getListOrders();
        ...
        for (Orders o : listOrders) {
            ...
            revenue += (p.getPrice() - (p.getPrice()*p.getSalePercent()/100))* o.getQuantity();
        }
        
        profit += pdao.getProfit(expenses, revenue);
